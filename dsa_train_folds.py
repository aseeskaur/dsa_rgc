...
if best_model_state_dict:
    torch.save(best_model_state_dict, f"/home/akaur101/data/f25/trained_dsa_models/dsa_rgc_bestmodel_fold{fold}_dict.pth")
    model.load_state_dict(best_model_state_dict)
    torch.save(model, f"/home/akaur101/data/f25/trained_dsa_models/dsa_rgc_bestmodel_fold{fold}.pth")
...
plt.legend()
plt.savefig(f'/home/akaur101/data/f25/dsa_results/loss_plot_fold{fold}.png')
plt.show()
