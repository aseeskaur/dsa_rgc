...
model.load_state_dict(torch.load(f"/home/akaur101/data/sp26/rgc/trained_dsa_models/dsa_rgc_bestmodel_fold{fold}_aug_dict.pth", map_location=device))
model.eval()
...
save_dir = Path(f"/home/akaur101/data/sp26/rgc/dsa_results/test_aug_fold_{fold}")
