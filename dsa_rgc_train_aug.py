...
if best_model_state_dict:
    torch.save(best_model_state_dict, f"/home/akaur101/data/sp26/rgc/trained_dsa_models/dsa_rgc_bestmodel_fold{fold}_aug_dict.pth")
    model.load_state_dict(best_model_state_dict)
    torch.save(model, f"/home/akaur101/data/sp26/rgc/trained_dsa_models/dsa_rgc_bestmodel_fold{fold}_aug.pth")
...
plt.legend()
plt.savefig(f'/home/akaur101/data/sp26/rgc/dsa_results/loss_plot_fold{fold}_aug.png')
plt.show()
