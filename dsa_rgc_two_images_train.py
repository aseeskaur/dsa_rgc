...
train_image_files = ["01.png", "02.png"]
train_images_padded = []
...
train_mask_files = ["01.png", "02.png"]
train_masks_padded = []
...
val_data = [(val_image_padded, val_mask_padded)]
...
if best_model_state_dict:
    torch.save(best_model_state_dict, "/home/akaur101/data/f25/dsa_rgc_two_images_bestmodel_dict")
    model.load_state_dict(best_model_state_dict)
    torch.save(model, "/home/akaur101/data/f25/dsa_rgc_two_images_image_bestmodel")
