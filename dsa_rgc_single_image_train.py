...
if best_model_state_dict:
    torch.save(best_model_state_dict, "/home/akaur101/data/f25/dsa_rgc_single_image_bestmodel_dict")
    model.load_state_dict(best_model_state_dict)
    torch.save(model, "/home/akaur101/data/f25/dsa_rgc_single_image_bestmodel")
